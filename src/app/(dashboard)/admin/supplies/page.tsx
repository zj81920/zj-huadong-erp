...
export default function SuppliesPage() {
  ...
  }, [search, filterCategory, pagination.page, pagination.pageSize]);
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="col-span-2">
              <label className="block text-[13px] font-semibold text-[#1D1D1F] mb-1.5">
                名称 <span className="text-[#FF3B30]">*</span>
              </label>
              <input
                type="text"
                className="ios-input"
            ...
            <div>
              <label className="block text-[13px] font-semibold text-[#1D1D1F] mb-1.5">分类</label>
              <select
            ...
            <div>
              <label className="block text-[13px] font-semibold text-[#1D1D1F] mb-1.5">规格</label>
              <input
                type="text"
                className="ios-input"
                placeholder="规格型号"
            ...
            <div>
              <label className="block text-[13px] font-semibold text-[#1D1D1F] mb-1.5">单位</label>
              <input
                type="text"
                className="ios-input"
                placeholder="如：个、箱、盒"
            ...
            <div>
              <label className="block text-[13px] font-semibold text-[#1D1D1F] mb-1.5">数量</label>
              <input
                type="number"
                className="ios-input"
                placeholder="0"
            ...
            <div>
              <label className="block text-[13px] font-semibold text-[#1D1D1F] mb-1.5">单价（元）</label>
              <input
                type="number"
                className="ios-input"
                placeholder="0.00"
            ...
            <div>
              <label className="block text-[13px] font-semibold text-[#1D1D1F] mb-1.5">总价（自动计算）</label>
              <input
                type="text"
        ...
        {detailItem && (
          <div className="space-y-3">
            <div className="grid grid-cols-2 gap-3">
              <div>
                <p className="text-[12px] text-[#86868B] mb-0.5">名称</p>
                <p className="text-[14px] font-semibold text-[#1D1D1F]">{detailItem.name}</p>
              </div>
              <div>
                <p className="text-[12px] text-[#86868B] mb-0.5">分类</p>
              ...
              <div>
                <p className="text-[12px] text-[#86868B] mb-0.5">规格</p>
                <p className="text-[14px] text-[#1D1D1F]">{detailItem.spec || "-"}</p>
              </div>
              <div>
                <p className="text-[12px] text-[#86868B] mb-0.5">单位</p>
                <p className="text-[14px] text-[#1D1D1F]">{detailItem.unit || "-"}</p>
              </div>
              <div>
                <p className="text-[12px] text-[#86868B] mb-0.5">数量</p>
                <p className="text-[14px] text-[#1D1D1F]">{detailItem.quantity}</p>
              </div>
              <div>
                <p className="text-[12px] text-[#86868B] mb-0.5">单价</p>
                <p className="text-[14px] text-[#1D1D1F]">{formatDecimal(detailItem.unitPrice)}</p>
              </div>
              <div>
                <p className="text-[12px] text-[#86868B] mb-0.5">总价</p>
                <p className="text-[14px] font-semibold text-[#1D1D1F]">{formatDecimal(detailItem.totalPrice)}</p>
              </div>
              <div>
                <p className="text-[12px] text-[#86868B] mb-0.5">存放位置</p>
                <p className="text-[14px] text-[#1D1D1F]">{detailItem.storeLocation || "-"}</p>
              </div>
              <div className="col-span-2">
