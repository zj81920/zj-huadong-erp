  ...
  return (
    <div className="mb-8">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h2 className="text-[15px] font-bold text-[#1C1917]">商务报价</h2>
        {quoteCount > 0 && (
      ...
      <div className="bento-card-static mb-4">
        <div className="flex items-center gap-3">
          <span className="text-[13px] font-semibold text-[#1C1917]">报价状态:</span>
          <select
          ...
          {statusSaving && (
            <span className="text-[12px] text-[#78716C]">保存中...</span>
          )}
        </div>
      </div>
      ...
      {quoteCount === 0 ? (
        <div className="bento-card-static">
          <div className="empty-state py-8">
            <Calculator className="w-8 h-8 text-[#78716C]" />
            <p>暂无报价记录</p>
            <p className="text-[12px] text-[#78716C]">点击上方按钮创建报价单</p>
          </div>
        </div>
      ) : (
              ...
              <div key={q.id} className="bento-card-static">
                ...
                <div className="grid grid-cols-2 gap-3 mb-3">
                  <div className="p-2.5 rounded-xl bg-[#FAFAF9]">
                    <p className="text-[11px] text-[#78716C] mb-0.5">报价金额</p>
                    <p className="text-[13px] font-semibold text-[#1C1917]">
                      {formatMoney(q.totalAmount)}
                    </p>
                  </div>
                  <div className="p-2.5 rounded-xl bg-[#FAFAF9]">
                    <p className="text-[11px] text-[#78716C] mb-0.5">创建时间</p>
                    <p className="text-[13px] font-semibold text-[#1C1917]">
                  ...
                  {q.adjustmentReason && (
                    <div className="p-2.5 rounded-xl bg-[#FAFAF9] col-span-2">
                      <p className="text-[11px] text-[#78716C] mb-0.5">相关说明</p>
                      <p className="text-[13px] font-semibold text-[#1C1917]">
                        {q.adjustmentReason}
                      </p>
                    </div>
                ...
                {qFiles.length > 0 && (
                  <div className="pt-3 border-t border-[#F5F5F4]">
                    <p className="text-[11px] text-[#78716C] mb-2">报价文件</p>
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-[13px] font-semibold text-[#1C1917] mb-1.5">
                报价总金额（元） <span className="text-[#78716C]">*</span>
              </label>
            ...
            <div className="space-y-5">
              <div className="flex items-center gap-3 pb-4 border-b border-[#F5F5F4]">
                <div className="w-12 h-12 rounded-2xl bg-[#78716C]/10 flex items-center justify-center">
                  <Calculator className="w-6 h-6 text-[#78716C]" />
                </div>
                <div>
                  <p className="text-[17px] font-bold text-[#1C1917]">
                    {lead.customer.name} - 报价单
                  </p>
                  <p className="text-[13px] text-[#78716C]">版本 v{detailItem.version}</p>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div className="p-3 rounded-xl bg-[#FAFAF9]">
                  <p className="text-[12px] text-[#78716C] mb-1">关联项目</p>
                  <p className="text-[14px] font-semibold text-[#1C1917]">{lead.projectName}</p>
                </div>
                <div className="p-3 rounded-xl bg-[#FAFAF9]">
                  <p className="text-[12px] text-[#78716C] mb-1">报价总金额</p>
              ...
              {detailItem.adjustmentReason && (
                <div className="p-3 rounded-xl bg-[#FAFAF9]">
                  <p className="text-[12px] text-[#78716C] mb-1">相关说明</p>
                  <p className="text-[14px] font-semibold text-[#1C1917]">
                    {detailItem.adjustmentReason}
                  </p>
                </div>
              ...
              {detailFiles.length > 0 && (
                <div>
                  <p className="text-[12px] text-[#78716C] mb-2">报价文件</p>
      ...
      >
        <div className="text-center">
          ...
          <p className="text-[15px] text-[#1C1917] mb-1">确定要删除该报价单吗？</p>
