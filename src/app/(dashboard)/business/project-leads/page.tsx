    ...
    <>
      ...
      <div className="grid grid-cols-3 gap-5 mb-6">
        <div className="bento-card-static flex items-center gap-4">
          ...
          <div>
            <p className="text-[13px] text-[#78716C]">线索总数</p>
        ...
        <div className="bento-card-static flex items-center gap-4">
          <div className="w-11 h-11 rounded-2xl bg-[#78716C]/10 flex items-center justify-center">
            <Info className="w-5 h-5 text-[#78716C]" />
          </div>
          <div>
            <p className="text-[13px] text-[#78716C]">投标中</p>
            <p className="text-[24px] font-bold text-[#78716C] leading-tight">{stats.bidding}</p>
          </div>
        </div>
        <div className="bento-card-static flex items-center gap-4">
          <div className="w-11 h-11 rounded-2xl bg-[#78716C]/10 flex items-center justify-center">
          ...
          <div>
            <p className="text-[13px] text-[#78716C]">报价中</p>
            <p className="text-[24px] font-bold text-[#78716C] leading-tight">{stats.quotation}</p>
          </div>
        </div>
      </div>
      ...
      >
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-[13px] font-semibold text-[#1C1917] mb-1.5">
                实施主体 <span className="text-[#78716C]">*</span>
              </label>
              <select
                className="ios-select"
