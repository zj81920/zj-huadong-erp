      ...
      <div className="bento-card-static">
        <div className="filter-bar">
          ...
          <div className="flex items-center gap-2">
            <span className="text-[13px] text-[#86868B]">方向</span>
          ...
          <div className="flex items-center gap-2">
            <span className="text-[13px] text-[#86868B]">状态</span>
            {statusFilters.map((f) => (
              <button
                key={f.value}
                className={`ios-btn ios-btn-sm ${
        ...
        <div className="grid grid-cols-4 gap-4 px-4 pt-4">
          <div className="bg-white rounded-xl p-3 border border-[#E5E5EA]">
            <p className="text-[12px] text-[#86868B] mb-1">开票总额</p>
            <p className="text-[18px] font-bold font-mono text-[#34C759]">
          ...
          <div className="bg-white rounded-xl p-3 border border-[#E5E5EA]">
            <p className="text-[12px] text-[#86868B] mb-1">收票总额</p>
            <p className="text-[18px] font-bold font-mono text-[#007AFF]">
          ...
          <div className="bg-white rounded-xl p-3 border border-[#E5E5EA]">
            <p className="text-[12px] text-[#86868B] mb-1">销项税额</p>
            <p className="text-[18px] font-bold font-mono text-[#FF9500]">
          ...
          <div className="bg-white rounded-xl p-3 border border-[#E5E5EA]">
            <p className="text-[12px] text-[#86868B] mb-1">进项税额</p>
          ...
          <div className="space-y-3 p-4">
            {invoices.map((inv) => {
              ...
              return (
                <div
                  key={inv.id}
                  className="bg-white rounded-2xl shadow-sm border border-[#E5E5EA] overflow-hidden transition-all duration-200"
                >
                  <div
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-semibold text-[15px] text-[#1D1D1F] font-mono">
                          {inv.invoiceNo}
                        </span>
                      </div>
                      <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-3 text-[13px] mb-1.5">
                      ...
                      <span className="text-[#E5E5EA]">|</span>
                      <span className="text-[#86868B]">{formatDate(inv.invoiceDate)}</span>
                    </div>

                    <div className="flex items-center gap-3 text-[13px] text-[#86868B] mb-1">
                      {inv.project && (
                        <>
                  ...
                  {isExpanded && (
                    <div className="px-4 pb-4 border-t border-[#F0F0F0]">
                      <div className="grid grid-cols-2 gap-x-6 gap-y-3 py-4">
                        <div>
                          <span className="text-[12px] text-[#86868B]">发票代码</span>
                          <p className="text-[13px] text-[#1D1D1F] font-mono mt-0.5">
                            {inv.invoiceCode || "-"}
                          </p>
                        </div>
                        <div>
                          <span className="text-[12px] text-[#86868B]">不含税金额</span>
                          <p className="text-[13px] text-[#1D1D1F] font-mono mt-0.5">
                            ¥{formatAmount(inv.amount)}
                          </p>
                        </div>
                        <div>
                          <span className="text-[12px] text-[#86868B]">税率</span>
                          <p className="text-[13px] text-[#1D1D1F] mt-0.5">
                            {(inv.taxRate * 100).toFixed(0)}%
                          </p>
                        </div>
                        <div>
                          <span className="text-[12px] text-[#86868B]">税额</span>
                          <p className="text-[13px] text-[#1D1D1F] font-mono mt-0.5">
                      ...
                      <div className="rounded-xl bg-[#F5F5F7] p-3 space-y-2 mb-3">
                        <div className="flex items-start gap-4">
                          <div className="flex-1">
                            <span className="text-[12px] text-[#86868B]">销方名称</span>
                            <p className="text-[13px] text-[#1D1D1F] mt-0.5">
                              {inv.sellerName || "-"}
                            </p>
                          </div>
                          <div className="flex-1">
                            <span className="text-[12px] text-[#86868B]">销方税号</span>
                            <p className="text-[13px] text-[#1D1D1F] font-mono mt-0.5">
                              {inv.sellerTaxNo || "-"}
                            </p>
                          </div>
                        ...
                        <div className="flex items-start gap-4">
                          <div className="flex-1">
                            <span className="text-[12px] text-[#86868B]">购方名称</span>
                            <p className="text-[13px] text-[#1D1D1F] mt-0.5">
                              {inv.buyerName || "-"}
                            </p>
                          </div>
                          <div className="flex-1">
                            <span className="text-[12px] text-[#86868B]">购方税号</span>
                            <p className="text-[13px] text-[#1D1D1F] font-mono mt-0.5">
                              {inv.buyerTaxNo || "-"}
                            </p>
                          </div>
                      ...
                      {inv.remark && (
                        <div className="mb-3">
                          <span className="text-[12px] text-[#86868B]">备注</span>
                          <p className="text-[13px] text-[#1D1D1F] mt-0.5">{inv.remark}</p>
                        </div>
                      )}

                      {inv.attachments && inv.attachments.length > 0 && (
                        <div className="mb-3">
                          <span className="text-[12px] text-[#86868B] block mb-2">
                            发票扫描件
                          </span>
                          <div className="flex flex-wrap gap-2">
                            {inv.attachments.map((url, idx) => (
                              <a
                                ...
                                className="w-16 h-16 rounded-lg border border-[#E5E5EA] overflow-hidden hover:shadow-md transition-shadow"
                              >
                                <img
                                  src={url}
                                  alt={`扫描件 ${idx + 1}`}
      ...
      >
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-[13px] font-semibold text-[#1D1D1F] mb-1.5">
                开票日期 <span className="text-[#FF3B30]">*</span>
              </label>
              <input
                type="date"
                className="ios-input"
            ...
            <div className="col-span-2 h-px bg-[#F0F0F0]" />
            ...
            <div className="col-span-2">
              ...
              <div className="flex flex-wrap gap-2 mb-2">
                {form.attachments.map((url, idx) => (
                  <div
                    key={idx}
                    className="relative w-20 h-20 rounded-lg border border-[#E5E5EA] overflow-hidden group"
                  >
                    <img
                      src={url}
                      alt={`扫描件 ${idx + 1}`}
                ...
                <label className="w-20 h-20 rounded-lg border-2 border-dashed border-[#E5E5EA] flex flex-col items-center justify-center cursor-pointer hover:border-[#007AFF] hover:bg-[#007AFF]/5 transition-colors">
      ...
      >
        {detailItem && (
          <div className="space-y-4">
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-2">
                <span className="font-semibold text-[17px] text-[#1D1D1F] font-mono">
            ...
            <div className="rounded-xl bg-[#F5F5F7] p-4 space-y-3">
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <span className="text-[12px] text-[#86868B]">发票方向</span>
                  <p
                ...
                <div>
                  <span className="text-[12px] text-[#86868B]">开票日期</span>
                  <p className="text-[13px] text-[#1D1D1F] mt-0.5">
                    {formatDate(detailItem.invoiceDate)}
                  </p>
                </div>
                <div>
                  <span className="text-[12px] text-[#86868B]">来源类型</span>
                  <p className="text-[13px] text-[#1D1D1F] mt-0.5">
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="rounded-xl bg-[#F5F5F7] p-3 text-center">
                <span className="text-[11px] text-[#86868B] block">不含税金额</span>
                <p className="text-[15px] font-semibold text-[#1D1D1F] font-mono mt-1">
              ...
              <div className="rounded-xl bg-[#F5F5F7] p-3 text-center">
                ...
                <p className="text-[15px] font-semibold text-[#FF9500] font-mono mt-1">
                  ¥{formatAmount(detailItem.taxAmount)}
                </p>
              </div>
              <div className="rounded-xl bg-[#F5F5F7] p-3 text-center">
                <span className="text-[11px] text-[#86868B] block">价税合计</span>
                <p className="text-[15px] font-semibold text-[#007AFF] font-mono mt-1">
            ...
            <div className="rounded-xl border border-[#E5E5EA] p-4 space-y-3">
              <div>
                <span className="text-[12px] text-[#86868B]">销方信息</span>
                <p className="text-[13px] text-[#1D1D1F] mt-0.5">
              ...
              <div>
                <span className="text-[12px] text-[#86868B]">购方信息</span>
                <p className="text-[13px] text-[#1D1D1F] mt-0.5">
            ...
            {detailItem.project && (
              <div>
                <span className="text-[12px] text-[#86868B]">关联项目</span>
                <p className="text-[13px] text-[#1D1D1F] mt-0.5">
                ...
                <div className="grid grid-cols-3 gap-2">
                  {detailItem.attachments.map((url, idx) => (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="aspect-square rounded-xl border border-[#E5E5EA] overflow-hidden hover:shadow-lg transition-shadow"
                    >
                      <img
                        src={url}
                        alt={`扫描件 ${idx + 1}`}
            ...
            <div className="text-[11px] text-[#C7C7CC] pt-2 border-t border-[#F0F0F0]">
