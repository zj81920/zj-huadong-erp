      ...
      >
        <div className="space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-[13px] font-semibold text-[#1D1D1F] mb-1.5">需求日期</label>
          ...
          <div className="pt-2">
            <div className="flex items-center justify-between mb-3">
              <label className="block text-[13px] font-semibold text-[#1D1D1F]">
                ...
                物资明细 <span className="text-[#FF3B30]">*</span>
              </label>
            ...
            <div className="overflow-x-auto border border-[#E5E5EA] rounded-xl">
              <table className="w-full text-[13px]">
                <thead className="bg-[#F5F5F7]">
                  <tr>
                    <th className="py-2 px-2 text-center font-semibold text-[#86868B] w-[44px]">序号</th>
                    <th className="py-2 px-2 text-left font-semibold text-[#1D1D1F] min-w-[120px]">物资名称<span className="text-[#FF3B30] ml-0.5">*</span></th>
                    <th className="py-2 px-2 text-left font-semibold text-[#1D1D1F] min-w-[100px]">规格型号</th>
                    <th className="py-2 px-2 text-left font-semibold text-[#1D1D1F] min-w-[60px]">材质</th>
                    <th className="py-2 px-2 text-left font-semibold text-[#1D1D1F] min-w-[80px]">品牌</th>
                    <th className="py-2 px-2 text-left font-semibold text-[#1D1D1F] min-w-[90px]">适用标准号</th>
                    <th className="py-2 px-2 text-left font-semibold text-[#1D1D1F] min-w-[60px]">单位</th>
                    <th className="py-2 px-2 text-left font-semibold text-[#1D1D1F] min-w-[70px]">数量</th>
                    <th className="py-2 px-2 text-left font-semibold text-[#1D1D1F] min-w-[80px]">备注</th>
                    <th className="py-2 px-2 text-center font-semibold text-[#86868B] w-[44px]">操作</th>
                  </tr>
                </thead>
                <tbody>
                  {form.items.map((item, index) => (
                    <tr key={index} className="border-t border-[#F0F0F0] hover:bg-[#FAFAFA]">
                      <td className="py-1.5 px-2 text-center text-[#86868B]">{index + 1}</td>
                      ...
                      <td className="py-1.5 px-2 text-center">
                        <button
                          className="w-6 h-6 rounded-full bg-[#FF3B30]/10 hover:bg-[#FF3B30]/20 flex items-center justify-center transition-colors mx-auto"
        ...
        {detailRecord && (
          <div className="space-y-5">
            <div className="grid grid-cols-3 gap-4">
              <div>
                <label className="block text-[12px] text-[#86868B] mb-1">计划单号</label>
                <p className="text-[15px] font-mono font-semibold text-[#007AFF]">{detailRecord.requestNo}</p>
              </div>
              <div>
                <label className="block text-[12px] text-[#86868B] mb-1">项目源ID</label>
              ...
              <div>
                <label className="block text-[12px] text-[#86868B] mb-1">状态</label>
                ...
                <table className="w-full text-[13px]">
                  ...
                  <tbody>
                    ...
                    {(!detailRecord.items || detailRecord.items.length === 0) && (
                      <tr>
                        <td colSpan={9} className="py-6 text-center text-[#86868B]">
                          暂无物资明细
                        </td>
                      </tr>
                    )}
