              ...
              {BUSINESS_MODULE_GROUPS.map((group) => (
                <div key={group.label}>
                  <div className="px-5 py-2">
                    <span className="text-[11px] font-semibold text-[#8E8E93] uppercase tracking-wider">{group.label}</span>
                  </div>
            ...
            <div className="flex flex-col items-center pb-6">
              ...
              {nodes.map((node, index) => (
                <div key={index} className="flex flex-col items-center">
                  <div className="bg-white/80 backdrop-blur-xl rounded-2xl border border-[#E5E5EA] shadow-sm px-5 py-4 w-[480px] transition-all duration-200 hover:shadow-md hover:border-[#007AFF]/30">
                            ...
                            >
                              <span
                                className={`w-3.5 h-3.5 rounded-full border-2 flex items-center justify-center flex-shrink-0 transition-all duration-150 ${
                                  selected ? "border-[#007AFF] bg-[#007AFF]" : "border-[#D1D1D6] bg-white"
                                }`}
                              >
