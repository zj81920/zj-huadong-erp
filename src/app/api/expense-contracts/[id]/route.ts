...
export async function PUT(
  ...
  try {
    ...
    const editCheck = await checkEditPermission("expense_contract", "contracts.expense", existing.status, existing.createdById);
...
export async function DELETE(
  ...
  try {
    ...
    const deleteCheck = await checkDeletePermission("expense_contract", "contracts.expense", existing.status, existing.createdById);
